<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="OnlineFootwareApp.Order" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Label ID="Label5" runat="server" Text="TotalAmount : "></asp:Label>
